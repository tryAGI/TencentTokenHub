<div class="docs-hero">
  <h1>TencentTokenHub</h1>
  <p class="docs-hero-lead">Modern .NET SDK for Tencent Cloud TokenHub APIs, generated with AutoSDK from a hand-maintained OpenAPI definition.</p>
  <div class="docs-badge-row">
    <a href="https://www.nuget.org/packages/TencentTokenHub/"><img alt="Nuget package" src="https://img.shields.io/nuget/vpre/TencentTokenHub"></a>
    <a href="https://github.com/tryAGI/TencentTokenHub/actions/workflows/dotnet.yml"><img alt="dotnet" src="https://github.com/tryAGI/TencentTokenHub/actions/workflows/dotnet.yml/badge.svg?branch=main"></a>
    <a href="https://github.com/tryAGI/TencentTokenHub/blob/main/LICENSE.txt"><img alt="License: MIT" src="https://img.shields.io/github/license/tryAGI/TencentTokenHub"></a>
...
<div class="docs-feature-grid">
  <div class="docs-feature-card">
    ...
    <p>Built from a hand-maintained OpenAPI file based on <a href="https://www.tencentcloud.com/document/product/1300/78941">Tencent Cloud TokenHub protocol docs</a>.</p>
  </div>
  <div class="docs-feature-card">
    <h3>Auto-updated</h3>
...
```csharp
using TencentTokenHub;

using var client = new TencentTokenHubClient(apiKey);
```
...
<div class="docs-card-grid">
  <div class="docs-card">
    <h3>Bugs</h3>
    <p>Open an issue in <a href="https://github.com/tryAGI/TencentTokenHub/issues">tryAGI/TencentTokenHub</a>.</p>
  </div>
  <div class="docs-card">
    <h3>Ideas and questions</h3>
    <p>Use <a href="https://github.com/tryAGI/TencentTokenHub/discussions">GitHub Discussions</a> for design questions and usage help.</p>
  </div>
  <div class="docs-card">
    <h3>Community</h3>
