...
The TencentTokenHub SDK provides integration with [Microsoft.Extensions.AI](https://learn.microsoft.com/en-us/dotnet/ai/microsoft-extensions-ai), enabling seamless interoperability with the unified .NET AI abstractions.

## Installation

```bash
dotnet add package TencentTokenHub
```
...
using var client = new TencentTokenHubClient(
    apiKey: Environment.GetEnvironmentVariable("TENCENTTOKENHUB_API_KEY")!);
