...
namespace TencentTokenHub
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::TencentTokenHub.AutoSDKRetryOptions Retry { get; set; } = new global::TencentTokenHub.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::TencentTokenHub.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::TencentTokenHub.IAutoSDKHook>();
        ...
        public global::TencentTokenHub.AutoSDKClientOptions AddHook(
            global::TencentTokenHub.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::TencentTokenHub.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::TencentTokenHub.AutoSDKClientOptions UseAuthorizationProvider(
            global::TencentTokenHub.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::TencentTokenHub.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::TencentTokenHub.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::TencentTokenHub.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::TencentTokenHub.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::TencentTokenHub.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::TencentTokenHub.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::TencentTokenHub.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::TencentTokenHub.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::TencentTokenHub.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::TencentTokenHub.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::TencentTokenHub.AutoSDKRetryOptions? Retry { get; set; }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::TencentTokenHub.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::TencentTokenHub.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::TencentTokenHub.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::TencentTokenHub.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::TencentTokenHub.AutoSDKClientOptions clientOptions,
            global::TencentTokenHub.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::TencentTokenHub.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::TencentTokenHub.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::TencentTokenHub.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::TencentTokenHub.AutoSDKClientOptions clientOptions,
            global::System.Func<global::TencentTokenHub.IAutoSDKHook, global::TencentTokenHub.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::TencentTokenHub.AutoSDKHookContext context)
        {
